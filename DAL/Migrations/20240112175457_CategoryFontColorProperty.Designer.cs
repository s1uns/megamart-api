...
namespace DAL.Migrations
{
    ...
    [Migration("20240112175457_CategoryFontColorProperty")]
    partial class CategoryFontColorProperty
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.Models.Category", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varchar(255)")
                        .HasDefaultValue("2b0a10d0-b2ba-451d-8262-0df056e6d172");
            ...
            modelBuilder.Entity("Core.Models.Customer", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varchar(255)")
                        .HasDefaultValue("942899ed-639f-4e37-8157-72608bc58d7c");

                    b.Property<DateTime?>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 1, 12, 17, 54, 57, 89, DateTimeKind.Utc).AddTicks(5779));
            ...
            modelBuilder.Entity("Core.Models.DeliveryAddress", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varchar(255)")
                        .HasDefaultValue("9fb250a4-13a0-4c1f-9be4-556e4611922d");
            ...
            modelBuilder.Entity("Core.Models.DeliveryMethod", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varchar(255)")
                        .HasDefaultValue("7ed65c67-3996-4f9a-8ebc-b3ea15245848");
            ...
            modelBuilder.Entity("Core.Models.Good", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varchar(255)")
                        .HasDefaultValue("29bc9816-d45f-4d77-9a87-5ba66d97cf1b");
            ...
            modelBuilder.Entity("Core.Models.Order", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varchar(255)")
                        .HasDefaultValue("f2ca8fe8-433d-44d7-968c-61756de4f55c");

                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 1, 12, 17, 54, 57, 90, DateTimeKind.Utc).AddTicks(3102));
            ...
            modelBuilder.Entity("Core.Models.OrderPosition", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varchar(255)")
                        .HasDefaultValue("19ffc6f2-d3b1-47d5-8cd0-3ec1cb5649eb");
            ...
            modelBuilder.Entity("Core.Models.Seller", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varchar(255)")
                        .HasDefaultValue("465035f7-7890-4f84-90c8-025debf42af6");
