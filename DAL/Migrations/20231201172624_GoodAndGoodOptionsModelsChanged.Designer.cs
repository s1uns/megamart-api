...
namespace DAL.Migrations
{
    ...
    [Migration("20231201172624_GoodAndGoodOptionsModelsChanged")]
    partial class GoodAndGoodOptionsModelsChanged
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.Models.Category", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varchar(255)")
                        .HasDefaultValue("3a64cbd9-558e-48eb-8596-0ec00ce45e96");
            ...
            modelBuilder.Entity("Core.Models.Customer", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varchar(255)")
                        .HasDefaultValue("9c6ff569-d1e0-4d8c-803e-c9aa4f47aeaf");

                    b.Property<DateTime?>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 12, 1, 17, 26, 24, 540, DateTimeKind.Utc).AddTicks(5135));
            ...
            modelBuilder.Entity("Core.Models.DeliveryAddress", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varchar(255)")
                        .HasDefaultValue("8431159e-caab-418d-b577-42b22c47b52e");
            ...
            modelBuilder.Entity("Core.Models.DeliveryMethod", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varchar(255)")
                        .HasDefaultValue("be3e62f4-2581-4d3e-9db6-92b775ddab2e");
            ...
            modelBuilder.Entity("Core.Models.Good", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varchar(255)")
                        .HasDefaultValue("8f799748-b5ca-4506-b9c0-74c619a1e488");
            ...
            modelBuilder.Entity("Core.Models.Order", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varchar(255)")
                        .HasDefaultValue("6fe3b082-002d-41e0-8fb0-2bd04559256f");

                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 12, 1, 17, 26, 24, 541, DateTimeKind.Utc).AddTicks(2105));
            ...
            modelBuilder.Entity("Core.Models.OrderPosition", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varchar(255)")
                        .HasDefaultValue("58067c91-c6f8-489f-bdcf-489b1fc223ad");
            ...
            modelBuilder.Entity("Core.Models.Seller", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varchar(255)")
                        .HasDefaultValue("d19b8d8f-7268-44d8-afcc-37bac1cf324c");
